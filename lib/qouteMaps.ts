...
export const QUOTE_LINE_MAP: QuoteLineSource[] = [
  ...
  { code: 'B8', description: 'River sand', unit: 'm3', rate: 20.0, section: 'FOUNDATION' },
  { code: 'C8', description: 'Pit sand', unit: 'm3', rate: 20.0, section: 'FOUNDATION' },
  { code: 'D8', description: '19mm Grenite Quarry Stone aggregate', unit: 'm3', rate: 45.0, section: 'FOUNDATION' },
  { code: 'G7', description: 'Imported  inert granular fill/Hrdcore', unit: 'm3', rate: 10.0, section: 'FOUNDATION' },
  { code: 'F8', description: 'Cement PC 15 (50kg bags)', unit: 'm3', rate: 55.0, section: 'FOUNDATION' },
  { code: 'F15', description: 'Cement (50kg bag)', unit: 'bags', rate: 12.50, section: 'FOUNDATION' },
  { code: 'C41', description: 'Termite Poison', unit: 'litre', rate: 0.90, section: 'FOUNDATION' },
  ...
  { code: 'A36', description: 'Pit sand', unit: 'm3', rate: 20, section: 'SUPERSTRUCTURE' },
  { code: 'A45', description: 'River Sand', unit: 'm3', rate: 20, section: 'SUPERSTRUCTURE' },
 ...
 // {code: '', description: '19mm Grenite Quarry Stone aggrecates', unit: 'm3', rate: 45, section: 'SUPERSTRUCTURE' },
  ...
  { code: 'F54', description: 'Y12 reinforcemet steel', unit: 'Length', rate: 5.20, section: 'SUPERSTRUCTURE' },
  ...
  { code: 'E22+E33', description: 'Cement PC 15 (50kg bags)', unit: 'bags', rate: 12.5, section: 'PLASTERING' },
   ...
   { code: 'L22', description: 'One coat 1:4 cement sand plaster finished with a wood float on extenal wall', unit: 'm3', rate: 2.50, section: 'PLASTERING' },
...
//  { code: 'F66', description: 'Roll top ridges ', unit: 'no', rate: 1.50, section: 'ROOF COVERING' },
 ...
 { code: 'H6', description: 'Site clearance', unit: 'm2', rate: 0.20, section: 'LABOUR — SUB-STRUCTURE' },
  { code: 'I6', description: 'Setting out', unit: 'm2', rate: 0.70, section: 'LABOUR — SUB-STRUCTURE' },
